		...
		<div class="content">
			...
			if(isset($_POST['add'])){
				...
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($con, "INSERT INTO veterinario(id_veterinarios, , nombre, apellido, direccion, telefono, Genero)
															VALUES('$id_veterinarios','$nombre','$apellido','$direccion', '$tel_consultorio', '$tel_celular', '$Genero' )") or die(mysqli_error());
						if($insert){
