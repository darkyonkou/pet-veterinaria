...
<?php include("../header.php");?>
	...
	<div class="container">
		...
		<div class="col-lg-12">
			...
			<a href="../pet/consultas/index.php"><button class="btn btn-success text-left"><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span> Registros</button></a>
            <hr>
		</div>
